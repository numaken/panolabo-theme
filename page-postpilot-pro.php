<?php
/*
Template Name: PostPilot Pro - SNS自動化ツール
*/
get_header();
?>
...
<section class="uk-section  parallax" style="background: linear-gradient(135deg, #69ba64 0%, #5aa659 100%); min-height: 550px;">
  <div class="uk-container">
    <div class="uk-grid-medium uk-flex-middle" uk-grid>
      ...
      <div class="uk-width-1-1 uk-width-1-2@m uk-text-center uk-margin-top uk-margin-remove-top@m">
        <div class="uk-position-relative uk-text-center uk-margin-large-top">
          <img src="<?php bloginfo('template_directory'); ?>/images/iphone.png" alt="PostPilot Pro アプリイメージ" class="uk-width-1-1" style="width: 50%; height: auto; position: relative; z-index: 2;" />
          <div class="uk-position-absolute" style="top: 2%; left: 27%; width: 57%; height: 119%; z-index: 1; overflow: hidden;">
            <iframe src="https://sns-automation-pwa.vercel.app/" width="100%" height="100%" frameborder="0" allowfullscreen style="transform: scale(0.8); transform-origin: top left; border-radius: 15px; overflow: hidden;"></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="uk-grid-match uk-child-width-1-4@m uk-text-center" uk-grid>
      ...
      <div>
        <div class="uk-card uk-card-body" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2);">
          ...
          <h4 class="uk-text-bold">📱 同時投稿対応</h4>
          <p>Twitter・Threads・Instagram（予定）に一括投稿。複数SNS管理も簡単</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="uk-section  uk-padding-large">
  <div class="uk-container">
    ...
    <p class="uk-text-center uk-margin-large-top uk-text-lead">革命的な「設定不要」体験で、<br class="uk-visible@s">あなたのSNS運用を劇的に効率化します。</p>
    <div class="uk-text-center uk-margin-top">
      <a href="https://sns-automation-pwa.vercel.app/" class="uk-button uk-button-text" target="_blank">無料体験・資料請求はこちら</a>
    </div>
  </div>
</section>
    ...
    <div class="uk-grid-match uk-child-width-1-3@m uk-text-center uk-margin-large-top" uk-grid>
      ...
      <div>
        <div class="uk-card uk-card-default uk-card-body">
          ...
          <div style="color: #69ba64; font-size: 2.5rem; font-weight: bold; margin: 1rem 0;">
            ¥0<span style="font-size: 1rem;">/月</span>
          </div>
          <p class="uk-text-muted uk-margin-bottom">機能体験版</p>
          ...
          <a href="https://sns-automation-pwa.vercel.app/" class="uk-button uk-button-text" target="_blank">無料で始める</a>
        </div>
      </div>
      ...
      <div>
        <div class="uk-card uk-card-body  postpilot-pricing-featured" style="background: linear-gradient(135deg, #69ba64 0%, #5aa659 100%); transform: scale(1.05); position: relative;">
          ...
          <div style="font-size: 2.5rem; font-weight: bold; margin: 1rem 0;">
            ¥980<span style="font-size: 1rem;">/月</span>
          </div>
          <p class="uk-margin-bottom" style="opacity: 0.8;">個人・中小企業向け</p>
          <ul class="uk-list uk-list-striped uk-text-left">
            <li>✅ AI投稿生成（無制限）</li>
            <li>✅ Twitter自動投稿</li>
            <li>✅ Threads自動投稿</li>
          ...
          <a href="https://sns-automation-pwa.vercel.app/" class="uk-button uk-button-text" target="_blank">今すぐ始める</a>
        </div>
      </div>
      ...
      <div>
        <div class="uk-card uk-card-default uk-card-body">
          <h3 class="uk-text-bold uk-margin-top">企業プラン</h3>
          <div style="color: #69ba64; font-size: 2.5rem; font-weight: bold; margin: 1rem 0;">
            ¥4,980<span style="font-size: 1rem;">/月</span>
          </div>
          <p class="uk-text-muted uk-margin-bottom">複数アカウント管理</p>
          <ul class="uk-list uk-list-striped uk-text-left">
            <li>✅ プレミアム機能全て</li>
            <li>✅ 複数アカウント管理</li>
            <li>✅ チーム機能</li>
