...
<!-- ヒーローセクション -->
<section class="uk-section uk-section-muted parallax" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/frontpage/hero-website.png'); min-height: 520px;">
  <div class="uk-container">
    <div class="uk-grid uk-flex-middle" uk-grid>
      <div class="uk-width-1-2@m">
        <div class="uk-overlay uk-dark uk-padding-large">
          <h1 class="uk-text-primary uk-text-bold">想いを、最短ルートでカタチに。</h1>
...
<section class="uk-section uk-section-default uk-padding-large">
  <div class="uk-container">
    ...
    <div class="uk-grid-small uk-child-width-expand@s uk-grid-match uk-margin-top uk-child-width-1-2@m uk-child-width-1-4@l" uk-grid>
      ...
      <!-- 更新しやすさ -->
      <div>
        <div class="uk-card uk-background-muted uk-card-body uk-text-center">
...
<section class="uk-section uk-section-muted uk-padding-large">
  <div class="uk-container">
    ...
    <div class="uk-grid-small uk-child-width-1-2@m uk-grid-match" uk-grid>
      <div>
      <div class="uk-card uk-background-default uk-card-body uk-text-center">
...
<section class="uk-section uk-section-muted uk-padding-large">
  <div class="uk-container">
    ...
    <div class="uk-child-width-1-3@m uk-grid-match" uk-grid>
      <div>
        <div class="uk-card uk-card-primary uk-card-body uk-light uk-card-hover">
      ...
      <div>
        <div class="uk-card uk-card-secondary uk-card-body uk-light uk-card-hover">
      ...
      <div>
        <div class="uk-card uk-card-danger uk-light uk-card-body uk-dark uk-card-hover">
          <h3 class="uk-text-bold">プレミアム</h3>
          <p>完全オリジナル＋アプリ対応</p>
          <p><strong>¥800,000〜</strong></p>
          <span class="uk-label uk-label-danger">人気</span>
...
<!-- お問い合わせ -->
<section id="contact" class="uk-section uk-section-muted uk-dark uk-padding-large">
  <div class="uk-container">
